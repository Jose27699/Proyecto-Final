...
function asignarAlumnoaGrupo() {
    ...
    Tool.setDataToLocalStorage("students", students);
}

function asignarProfesor(){

    let profesores = profesores[document.getElementById(`Profesores`).value]; 
    alumno.asignarProfesores(`Profesor`);
    let crr1 = new Carrera(profesores.value);
    
    Tool.setDataToLocalStorage("profesores", profesores);
